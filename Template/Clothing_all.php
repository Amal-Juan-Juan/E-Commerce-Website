<!-- Special Price -->
<?php
    $brand = array_map(function ($pro){ return $pro['item_brand']; }, $product_shuffle_Clothing);
    $unique = array_unique($brand);
    sort($unique);
    shuffle($product_shuffle_Clothing);
