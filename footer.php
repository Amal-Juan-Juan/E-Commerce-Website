...
<!-- start #footer -->
<footer id="footer" class="bg-danger text-white py-5" style="padding-top:2vw">
    <div class="container">
        <div class="row">
        <div class="col-lg-3 col-12">
            ...
            <div class="col-lg-2 col-12">
                ...
                <div class="d-flex flex-column flex-wrap">
                    <a href="myacc.php" class="font-rale font-size-14 text-white-50 pb-1">My Account</a>
...
<div class="copyright text-center bg-dark text-white py-2">
    <p class="font-rale font-size-14">&copy; Copyrights 2022</p>
</div>
<!-- !start #footer -->
